...
export default function SongStylesPage() {
    ...
    <div className="min-h-screen bg-cosmic">
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 py-24 md:py-32">
        ...
        >
          ...
          <h1 className="font-cinzel font-bold text-3xl sm:text-4xl md:text-5xl text-white">All 220 devotional styles</h1>
        ...
        <div className="space-y-14">
          {SONG_STYLE_GROUPS.map((group, i) => (
            <motion.section
              key={group.id}
              initial={{ opacity: 0, y: 24 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ type: 'tween', ease: [0.25, 0.46, 0.45, 0.94], duration: 0.5, delay: Math.min(i * 0.05, 0.3) }}
            >
